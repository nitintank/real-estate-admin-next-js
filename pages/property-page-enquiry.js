                        ...
                        <tbody>
                            {inquiries.map((inquiry, index) => (
                                <tr key={inquiry.id}>
                                    ...
                                    <td><Link href={`https://real-estate-gray-zeta.vercel.app/property?id=${inquiry.property_id}`} className={styles.link_tag} target='_blank'>{inquiry.property_name}</Link></td>
                                    <td>{inquiry.name}</td>
                                    <td>{inquiry.email}</td>
